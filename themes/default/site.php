                    ...
                    <table>
                        ...
                        <?php foreach ($this->site_pages as $row): ?>
                            <tr>
                                ...
                                <td><a href="/site/page/update?url=<?php echo urlencode($row['url']) ?>"><img src="<?php echo Options::get('theme_path') ?>images/arrow_refresh.png" alt="Update link count for <?php echo $row['url'] ?>"></a></td>
