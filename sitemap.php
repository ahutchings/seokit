...
<p>If you would like to input a lot of URL's it is sometimes better to use an xml sitemap rather than relying on Yahoo to return indexed pages.
<p><b>Note:</b> if you spider a site using this method the page titles will not be added to the database like they will be if you use <a href="addsite.php">this method</a>.
<p>Enter the xml sitemap location in the box below:
<form action="sitemap.php" method="get">
Sitemap URL: <input name="url" size="45" value="http://www.site.com/sitemap.xml" type="text" /><input value="Submit" style="width: 50px" type="submit" />
</form>
<?php
