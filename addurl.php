...
<p>If you would like to input just one webpage then enter it in the form below.
...
Web page URL: <input name="url" size="45" value="http://www.site.com/single-page" type="text" /><input value="Submit" style="width: 50px" type="submit" />
</form>
<?php
